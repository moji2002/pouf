...
/** Demo catalogue without charting dependencies. The documentation page uses
 * this as its primary island so Recharts stays out of the initial route. */
export const coreDemos: Record<string, Demo[]> = {
  stack: stackDemos,
  row: rowDemos,
  grid: gridDemos,
  shell: shellDemos,
